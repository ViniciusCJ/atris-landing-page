        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="mt-8">
                <h3 className="font-bold text-atris-black mb-4">Nos siga nas redes sociais:</h3>
      ...
      <footer className="atris-black text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <img src={atrisLogo} alt="Atris" className="h-20 w-auto mb-4 filter brightness-0 invert" />
